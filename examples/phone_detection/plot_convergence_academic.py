...
# 添加箭头
ax.annotate("", xy=(155, 0), xytext=(0, 0), arrowprops=dict(arrowstyle="->", color="black", lw=1.5))
ax.annotate("", xy=(0, 1.05), xytext=(0, 0), arrowprops=dict(arrowstyle="->", color="black", lw=1.5))
